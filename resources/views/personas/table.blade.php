<table class="table table-responsive" id="personas-table">
    ...
    @foreach($personas as $persona)
        <tr>
            ...
            <td><img src="{{ asset($persona->url_cedula) }}" class="img-circle" alt="User Image" width="60" height="60"></td>
            <td><img src="{{ asset($persona->url_carta_laboral)  }}" class="img-circle" alt="User Image" width="60" height="60"></td>
