...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('prestamos.create') !!}">Agregar nuevo</a>
        </h1>
    </section>
    <div class="content">
...
@section('scripts')
<script>
    urlPreDatatables = '{{ route('datatablepre') }}';
